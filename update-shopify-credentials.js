...
async function updateShopifyCredentials() {
  ...
  try {
    ...
    // Test the new token
    const testUrl = `https://45dv93-bk.myshopify.com/admin/api/2027-01/shop.json`;
    ...
    if (testResponse.ok) {
      ...
      const customerUrl = `https://45dv93-bk.myshopify.com/admin/api/2027-01/customers.json?limit=1`;
      ...
      const orderUrl = `https://45dv93-bk.myshopify.com/admin/api/2027-01/orders.json?limit=1&status=any&financial_status=any`;
