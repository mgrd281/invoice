    ...
    return (
        <div className="bg-white border-2 border-dashed border-slate-200 rounded-3xl p-20 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="max-w-md space-y-2">
                ...
                <p className="text-slate-500 font-medium">Verbinden Sie Ihren Shopify-Store oder erstellen Sie manuell Ihren ersten Kunden, um mit dem RM-Insights zu beginnen.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
                <Button className="bg-slate-900 hover:bg-slate-800 font-black h-12 px-8 rounded-xl shadow-xl shadow-slate-200">
                    <Plus className="w-4 h-4 mr-2" /> ERSTEN KUNDEN ERSTELLEN
                </Button>
                <Button variant="outline" className="border-slate-200 font-black h-12 px-8 rounded-xl">
