...
export async function GET(request: NextRequest) {
  ...
  try {
    const shopifyResponse = await fetch(`https://45dv93-bk.myshopify.com/admin/api/2027-01/shop.json`, {
      headers: {
    ...
    results.tests.push({
      ...
      endpoint: 'https://45dv93-bk.myshopify.com/admin/api/2027-01/shop.json',
